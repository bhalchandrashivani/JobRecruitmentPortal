...
<body>
    ...
    <div class="jumbotron">
        <h1 id="myHeader">POST A JOB HERE</h1>
    ...
    <div class="grid-2-6">
    <form class ="jobform" method="post" action = "${contextPath}/employer/jobpostsuccess.htm?name=${name}">
        ...
        <script language="javascript">populateCountries("job_type_country", "job_type_state");</script>
            <div>
                <label for="majorCat">Select industry in which the job belongs to<span class="asterisk">&#42;</span></label>
                <div>
            ...
            <div class="row-of-radio">
                ...
                <div>
                    ...
                    <div class="markItUpContainer">
                        <textarea rows="11" cols="42" placeholder="Describe the job briefly" class="textarea-markItUpHeader" name= "job_description"
                        id="job_description" spellcheck="true" style="z-index: auto; position: relative"; font-size: 19px;></textarea>
                    </div>                
                </div></div>
	    </div>
        <div style="text-align:center;">
        	<input type = "submit" class="btn btn-success btn-lg" value = "Post this Job" />
        </div>
        </form>
    </div>
</div>
